...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
	...
	<div class="articleDIV">
		<h1>여기는 게시판</h1>
		<form action="updateBoard" method="post" onsubmit="return formCheck()" enctype="multipart/form-data">
			<table>
				<tr>
					<th>제목</th>
					<td>
						<input type="text" name="title" required="required" value="${board.title }" id="title">
					</td>
				</tr>
				<tr>
					<th>본문</th>
				...
				<c:if test="${board.originalfile != null}">
					<tr>
						...
						<td>
							<span id="fileSpan">
								<a href="download?boardnum=${board.boardnum }" id="uploadedFile">
										${board.originalfile }
								</a>
								<input type="button" value="삭제" onclick="removeFile()" id="fileRemove">
							</span>
						</td>
					</tr>
				</c:if>
			</table>
			<input type="file" name="upload" onclick="removeFile()"><br>
			<input type="hidden" name="savedfile" value="${board.savedfile }">
			<input type="submit" value="등록">
			<input type="hidden" name="username" value="${sessionScope.userNickname }">
